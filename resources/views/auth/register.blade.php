            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="mobile" class="col-md-4 col-form-label text-md-end">{{ __('BirthDate') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if(isset($roles_list) && $roles_list->isNotEmpty())
                                    ...
                                    <option value = '{{ $role_val['id'] }}'> {{ $role_val['name'] }} </option>
                                    @endforeach
                                    @else
                        ...
                        <div class="row mb-3">
                            ...
                            <input type="checkbox" name="hobbies[]" value="dance">Dance<br>      
                                ...
                                <input type="checkbox" name="hobbies[]" value="draw">Drawing<br>
                                @error('hobbies')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
